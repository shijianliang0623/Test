		...
		Teacher te = new Teacher();
			switch(choice){
				case 1:
			         ...
			         te.add(new Student1(stuno,stupass,stuname,stusex,stuage,stutel,stuaddr));
				 ...
				 case 3:
			         ...
			         te.updateInfo(new Student1(stuno11,stupass11,stuname11,stusex11,stuage11,stutel11,stuaddr11));
